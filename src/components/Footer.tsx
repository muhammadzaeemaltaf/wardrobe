    ...
    <footer className="bg-gray-100 text-gray-800 py-10 px-4">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul>
            {categories.map(category => (
              <li key={category}>
                <Link className="mb-2 link w-fit" href={`/category/${category.toLowerCase()}`}>{category.split(" ").map(char => char.charAt(0).toUpperCase() + char.slice(1).toLocaleLowerCase()).join(" ")}</Link>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div>
          ...
          <ul>
            <li><Link className="mb-2 link w-fit" href="/">Home</Link></li>
            <li><Link className="mb-2 link w-fit" href="/shop">Shop</Link></li>
            <li><Link className="mb-2 link w-fit" href="/about">About</Link></li>
            <li><Link className="mb-2 link w-fit" href="/contact">Contact</Link></li>
          </ul>
        </div>
